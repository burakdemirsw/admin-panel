...
var CargoListComponent = /** @class */ (function () {
    ...
    CargoListComponent.prototype.getCargoDetail = function (cargo, openDialog) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cargoService.getPackageStatus(cargo.referenceId)];
                    case 1:
                        response = _a.sent();
                        if (openDialog) {
                            this.visible = true;
    ...
    CargoListComponent.prototype.createBarcode = function (referenceId) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.CargoListComponent = CargoListComponent;
