...
exports.AddProductToShelfListComponent = void 0;
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var createBarcode_1 = require("src/app/components/Product/create-barcode/models/createBarcode");
var AddProductToShelfListComponent = /** @class */ (function () {
    function AddProductToShelfListComponent(toasterService, productService, router, formBuilder, warehouseService, generalService, title, headerService) {
        var _this = this;
    ...
    AddProductToShelfListComponent.prototype.ngOnInit = function () {
    ...
    AddProductToShelfListComponent.prototype.route = function (isInQty) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AddProductToShelfListComponent.prototype.addInnerNumberToList = function (innerNumber) {
    ...
    AddProductToShelfListComponent.prototype.newCount = function () {
        return __awaiter(this, void 0, void 0, function () {
            var orderNo, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AddProductToShelfListComponent.prototype.newCount2 = function () {
        return __awaiter(this, void 0, void 0, function () {
            var orderNo, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AddProductToShelfListComponent.prototype.newCount3 = function () {
        return __awaiter(this, void 0, void 0, function () {
            var orderNo, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AddProductToShelfListComponent.prototype.getGetCountList = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.warehouseService.getProductOnShelfOperationList()];
                    case 1:
    ...
    AddProductToShelfListComponent.prototype.formGenerator = function () {
    ...
    AddProductToShelfListComponent.prototype.deleteCountFromId = function (orderNumber) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AddProductToShelfListComponent.prototype.onSubmit = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AddProductToShelfListComponent.prototype.showModal = function (operationNo) {
        this.selectedOrderNo = operationNo;
        this.visible = !this.visible;
    };
    AddProductToShelfListComponent.prototype.sendBarcodesToNebim = function (isPackage) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AddProductToShelfListComponent = __decorate([
        core_1.Component({
    ...
    return AddProductToShelfListComponent;
}());
exports.AddProductToShelfListComponent = AddProductToShelfListComponent;
