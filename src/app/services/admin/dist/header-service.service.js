...
exports.HeaderServiceService = void 0;
var core_1 = require("@angular/core");
var rxjs_1 = require("rxjs");
var HeaderServiceService = /** @class */ (function () {
    function HeaderServiceService() {
        this.pageTitleSource = new rxjs_1.BehaviorSubject('Default Page');
        this.currentPageTitle = this.pageTitleSource.asObservable();
    }
    HeaderServiceService.prototype.updatePageTitle = function (title) {
