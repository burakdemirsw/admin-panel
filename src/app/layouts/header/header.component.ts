...
import { ApplicationParameters } from 'src/app/models/const/ClientUrls';
...
export class HeaderComponent implements OnInit {
  ...
  headerTitle = ApplicationParameters.headerTitle;
  companyTitle = ApplicationParameters.companyTitle;
  userName: string;
  userId: string;
