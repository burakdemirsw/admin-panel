...
const routes: Routes = [
  ...
  {
    path: "create-cash-process/:applicationCode/:cashTransTypeCode/:activeIndex",
    component: CashProcessComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "create-cash-process/:applicationCode/:cashTransTypeCode/:activeIndex/:id",
    component: CashProcessComponent,
    canActivate: [AuthGuard],
  },

  {
    path: "create-bank-process/:applicationCode/:bankTransTypeCode",
    component: BankProcessComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "create-bank-process/:applicationCode/:bankTransTypeCode/:activeIndex",
    component: BankProcessComponent,
    canActivate: [AuthGuard],
  },
  {
  ...
  {
    path: "create-warehosue-process/:processType/:processCode/:activeIndex/:processId",
    component: CreateWarehouseProcessComponent,
    canActivate: [AuthGuard],
  },
  ...
  {
    path: "search/:target/:id",
    component: SearchQrComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "nebim-get-orders",
    component: NebimGetOrdersComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "nebim-stock-control",
    component: NebimStockControlComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "nebim-product-extract",
    component: NebimProductExtractComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "create-barcode/:operationNo",
    component: CreateBarcodeComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "marketplace-invoices",
    component: MarketplaceInvoicesComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "search-shelf",
    component: SearchShelfComponent,
    canActivate: [AuthGuard],
  },
  {
  ...
  {
    path: "collect-export-products/:id/:warehouseCode",
    component: CollectExportProductsComponent,
    canActivate: [AuthGuard],
  },
  {
  ...
  {
    path: "ideasoft-offers",
    component: IdeasoftOffersComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "authorization",
  ...
  { path: "role-list", component: RoleListComponent, canActivate: [AuthGuard] },
  {
    ...
    component: TransferredOrdersComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "customers/:type",
  ...
  {
    path: "retail-invoice-list",
    component: RetailInvoiceListComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "retail-orders-managament/:status/:invoiceStatus",
    component: RetailOrderManagementComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "retail-orders-collected-packages",
    component: CollectedPackagesComponent2,
    canActivate: [AuthGuard],
  },
  ...
  {
    path: "add-product-to-shelf/:innerProcessCode/:isCompleted/:isReturn/:id",
    component: AddProductToShelfComponent,
  },
  {
    path: "add-product-to-shelf/:innerProcessCode/:isCompleted/:isReturn/:isShelfBased/:id",
    component: AddProductToShelfComponent,
  },

  {
    path: "add-product-to-shelf/:innerProcessCode/:isCompleted",
    component: AddProductToShelfComponent,
  },
  {
    path: "inner-list/:innerProcessCode",
    component: AddProductToShelfListComponent,
  },
